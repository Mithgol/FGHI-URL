...
This repository does also contain a JavaScript module (for Node.js) as a proof of concept and a reference implementation. It is tested against Node.js v0.8.x, Node.js v0.10.x, Node.js v0.12.x and the latest stable version of io.js. An attempt of an npm-driven installation in Node 0.6 (or older) [would fail since 2014](https://github.com/npm/npm/issues/4379) anyway.
